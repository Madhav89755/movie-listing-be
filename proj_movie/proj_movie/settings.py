"""
Django settings for proj_movie project.
...
SECRET_KEY = "django-insecure-!se85s3qhcx-@f@7@7fm*i!^*1x_sn0!m%=5iz(w92&xi8*z&k"
...
WSGI_APPLICATION = "proj_movie.wsgi.application"
